        ...
        <tbody>
          {equipos.map((equipo) => (
            <tr key={equipo.n_inventario}>
              ...
              <td>
                <div>
                <button className='acciones' onClick={() => iniciarEdicion(equipo)}>Editar</button>
                <button className='acciones' onClick={() => handleEliminar(equipo.n_inventario)}>Eliminar</button>
                </div>
              </td>
            </tr>
          ))}
